...
Run diagnostic checks on the GMD project and optionally fix issues.

### Checks

1. **Required files**: .gmd/ directory exists, STATE.md, state.json, ROADMAP.md, config.json
...
- Initialize missing .gmd/ subdirectories
