...
Create a git branch to explore an alternative proof strategy or approach
without contaminating the main research line.

### Step 1: Name the Branch
Ask the user for:
- Branch name (e.g., "fractional-chi-approach", "entropy-method")
...
The user can now run normal GMD commands (plan-phase, execute-phase, etc.)
on this branch. All work is isolated from main.

### Step 5: Compare (via /gmd:compare-branches)
