...
Read `{GMD_INSTALL_DIR}/specs/workflows/execute-phase-workflow.md` first. Do NOT improvise.
...
### Pre-execution
1. Load state via gmd-state
2. Check conventions via gmd-conventions
...
2. For each plan/task in the wave (parallel):
   a. Spawn gmd-executor subagent with task context
...
4. Run inter-wave verification if configured (dimensional/convention checks)
5. Update STATE.md

### Post-Phase Verification
After all waves complete:
1. Spawn gmd-verifier with all phase artifacts
