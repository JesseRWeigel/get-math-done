 ...
 *
 * Usage:
 *   npx get-math-done                  # Interactive
 *   npx get-math-done --local          # Install into current project
 *   npx get-math-done --global         # Install globally
 *   npx get-math-done --uninstall      # Remove
 */
...
const BRAND = {
  name: "get-math-done",
  displayName: "Get Math Done",
  prefix: "gmd",
  pyModule: "gmd",
  homeDir: ".gmd",
  homeDirEnv: "GMD_HOME",
  description: "AI copilot for autonomous mathematics research",
  repo: "https://github.com/JesseRWeigel/get-math-done",
};
